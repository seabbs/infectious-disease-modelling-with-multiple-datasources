...
% Things to confirm before updating the main workflow

% key steps:
% 1 - Research Question and Target esimands
% 2 - Process DAG Development
% 3 - Data Source Selection
% 4 - Observation DAG Construction
% 5 - Modularise DAGs
% 6 - Inference and Computation Choices
% 7 - Model Implementation
% 8 - Model Specification and Validation
% 9 - Data Integration Choices

% Feedback loops:
% 3 - 2: Data characteristics fundamentally alter process DAG Structure
% 6 - 2: Fitting constraints may require approximating or restructuring the process DAG
% 6 - 5: Computational constraints may suggest refactoring the underlting model DAGs
% 6 - 8: Diagnostic failures may indicate model specification issues
% 6 - 9: Computational constraints or available expertise may favour approximate over exact joint approaches or ensembling approaches
% 7 - 9: Teams using incompatible programming languages may necessitate modular rather than joint approaches
% 8 - 2: Identifiability issues may necessitate model simplification or more complexity
% 8 - 3: Identifiability issues may require more data to fit the model
% 8 - 4: Identifiability issues may necessitate model simplification
% 7 - 3: Practical constraints may necessitate modular approaches
% 9 - 4: Integration complexity may require simplifying observation models
% 9 - 6: Update inference and computation choices for the newly combined models (solid line)
% 9 - 8: Conflict between data sources reveals model misspecification

% sub-iterations/cycles:
% 2 - 3 - 4
% 5 - 6 - 7 - 8
% consider describing in figure caption
...
We recommend starting with a simple representations of core transmission dynamics, then iteratively refining as understanding improves as as neeeded by other parts of the workflow.
...
Practitioners should test available automatic differentiation options when possible, with systems like Turing.jl and PyMC providing backend flexibility.
...
For some models, formal structural identifiability approaches \citep{jackson2019value,heath2024value} may be used to indicate where additional data or prior information is needed.
