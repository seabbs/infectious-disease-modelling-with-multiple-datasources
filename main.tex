...
We compare integration approaches, from full joint modelling to ensemble methods, and demonstrate through schematic case studies how practitioners can navigate real-world tradeoffs between model complexity, computational feasibility, and inferential goaldirected acyclic graphdirected acyclic graphs.
...
\item \textbf{DAG-based validation:} Test causal assumptions underlying multi-source integration using sensitivity analyses \citep{digitale2022tutorial}.
...
Example software & --- & Stan, PyMC, JAGS, NIMBLE & PyMC, LibBi & PyMC & R-INLA & Stan & abctools, EasyABC & --- \\
