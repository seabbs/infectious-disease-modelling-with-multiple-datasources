...
Often practitioners may find that aspects of our proposed workflow appear to need to be decided on in parallel, for example, the structure of the model and the inference method.
